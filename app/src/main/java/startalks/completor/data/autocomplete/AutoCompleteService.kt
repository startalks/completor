...
package startalks.completor.data.autocomplete

import android.content.Context
import androidx.annotation.WorkerThread
import startalks.completor.data.autocomplete.AutoCompleteService.AutoCompleteInputConfiguration
import startalks.completor.data.autocomplete.AutoCompleteService.AutoCompleteResult
import startalks.completor.data.autocomplete.AutoCompleteService.AutoCompleteServiceError
import startalks.completor.data.autocomplete.AutoCompleteService.InitModelResult
import startalks.completor.util.splitToWords
import startalks.completor.util.trimToMaxWordCount
